...
export default function SlaStatusColumn({ data }: SlaStatusColumnProps) {
  ...
  const getSlaStatusName = () => {
    switch (data.info) {
      case SlaStatus.valid:
        return SlaStatusNames.valid;
      case SlaStatus.validPlanned:
        return SlaStatusNames.valid;
      case SlaStatus.planned:
        return SlaStatusNames.planned;
      case SlaStatus.expired:
        return SlaStatusNames.expired;
      case SlaStatus.canceled:
        return SlaStatusNames.canceled;
    }
  };
  ...
  return (
    <div className="sla-status-column">
      <div
        className="sla-status-column__value"
        style={{ background: getSlaStatusColor() }}
      >
        {getSlaStatusName()}
      </div>
